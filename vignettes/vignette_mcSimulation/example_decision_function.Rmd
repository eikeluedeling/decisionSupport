...
We can use the `plot_distributions()` function to produce one of the several plotting options for distribution outputs. This shows us the outcome distribution of the decision (difference in NPV between do and do not do). 
