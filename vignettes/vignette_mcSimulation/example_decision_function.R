...
# This creates a dataframe as the one generated by decisionSupporrt
# but still having the issues with 'output'

test_mcSimulation_output_data_frame <- data.frame(p$y, p$x)
