...
plot_cashflow <- function(mcSimulation_object, cashflow_var_name, 
  ...
  ggplot2::ggplot(summary_subset_data, 
                  ggplot2::aes(x_scale)) +
    ggplot2::geom_ribbon(
      ggplot2::aes(ymin = p5, ymax = p95, fill="5 to 95")) +
    ggplot2::geom_ribbon(
      ggplot2::aes(ymin = p25, ymax = p75, fill="25 to 75")) +
    ggplot2::geom_line(
      ggplot2::aes(y = p50, color = "median")) +
    ggplot2::geom_line(
      ggplot2::aes(y = 0)) +
    ...
    ggplot2::labs(x= xlabel, y= ylabel, fill="Quantiles (%)", color = "") +
