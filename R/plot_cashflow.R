...
#' 
#' @param mcSimulationResults is a data frame of Monte Carlo simulations of cashflow outputs (in wide format, see example). Usually the "MCSimulationResults.csv" file generated by \code{\link[decisionSupport]{decisionSupport}} function.
...
#' 
plot_cashflow <- function(mcSimulationResults, cashflow_var_name, 
  ...
  assertthat::assert_that(is.data.frame(mcSimulationResults), msg = "mcSimulationResults is not a data frame.")
  
  data <- mcSimulationResults
