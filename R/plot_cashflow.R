...
#'
#' Creates a cashflow plot of the returned list of related outputs from the \code{\link[decisionSupport]{mcSimulation}} function using \code{\link[ggplot2]{ggplot2}}
#'
#' @author Eduardo Fernandez (\email{efernand@@uni-bonn.de})
#' @author Cory Whitney (\email{cory.whitney@@uni-bonn.de})
#'
#' @param mcSimulation_object is a data frame of Monte Carlo simulations of cashflow outputs (in wide format, see example). Usually the "mcSimulation_object.csv" file generated by \code{\link[decisionSupport]{mcSimulation}} function.
#' @param cashflow_var_name is the name (character string) for the variable name used to define cashflow in the returned list of outputs from the \code{\link[decisionSupport]{mcSimulation}} function. If multiple decision options are provided this will produce a comparative panel plot.
...
#' @param base_size is the base text size to be used for the plot. The default is 11, this is the \code{\link[ggplot2]{ggtheme}} default
#' @param ... accepts arguments to be passed to \code{\link[ggplot2]{ggtheme}}
#'
...
#'
#' variable <- c(
#'   "revenue_option1", "costs_option1", "n_years",
...
#'
#'   return(list(
#'     Revenues_option1 = revenue_option1,
...
plot_cashflow <- function(mcSimulation_object, cashflow_var_name,
  ...
  for (i in seq_along(cashflow_var_name)) {
  ...
  ggplot2::ggplot(
    ...
    ggplot2::guides(
      fill =
        ggplot2::guide_legend(reverse = TRUE, order = 1)
    ) +
