...
#'
#' predictionProfit1 <- mcSimulation(
...
#'
#' plot_distributions(
#'   mcSimulation_object = predictionProfit1, vars = c("Revenues", "Costs"),
...
#'
#' plot_distributions(
#'   mcSimulation_object = predictionProfit1, vars = c("Costs"),
...
plot_distributions <- function(mcSimulation_object,
  ...
  if (method == "hist_simple_overlay") {
    return(standard_plot + ggplot2::geom_histogram(
      color = NA, alpha = 0.5, bins = bins,
