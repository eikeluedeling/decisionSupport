...
#'   variable = c("cost_1", "cost_2", "benefit_1", "benefit_2"),
...
#'   Variable = c(
#'     "Runs", "cost_1", "cost_1", "cost_1", "cost_2", "cost_2",
#'     "benefit_1", "benefit_1", "benefit_2"
#'   ),
#'   param = c(
#'     "x", "lower", "upper", "distribution", "lower", "upper",
#'     "lower", "upper", "lower"
#'   ),
...
#' ### run a simulation
#'
#' results <- scenario_mc(base_estimate, scenarios,
